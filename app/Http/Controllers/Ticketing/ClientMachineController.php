...
class ClientMachineController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->service->update($id, $request->only(['client_account_id', 'product_id', 'invoice_id', 'serial_number', 'installed_at']));

        return redirect()->route('admin.client-machines.index')->with('success', 'Machine updated.');
    }
}
