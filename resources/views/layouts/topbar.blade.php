                ...
                <form class="app-search d-none d-md-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            <x-ui.empty-state icon="ri-search-line" message="Global search isn't available yet." />
                        </div>
                    </div>
                </form>
            </div>
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="{{ route('jobs.show', $notification->data['job_id']) }}" class="stretched-link">
                                                        <h6 class="mt-0 mb-1 fs-13 fw-semibold">{{ $notification->data['job_title'] }}</h6>
                                                    </a>
