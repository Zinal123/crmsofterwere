                                ...
                                <td><?php echo e($item->rate); ?></td>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item remove-item-btn" href="<?php echo e(route('product.delete' ,$item->id)); ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('productstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="col-xxl-6">
                            <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u411614341/domains/cms.oraclemachinetech.com/public_html/resources/views/product.blade.php ENDPATH**/ ?>