                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <a href="<?php echo e(route('invoice.create')); ?>" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody class="list form-check-all" id="invoice-list-data">
                                <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr>
                                  ...
                                  <td><?php echo e($item->paidamount); ?></td>
                                  <td><?php echo e($item->remaining_amount); ?></td>
                                  <td>
                                    <?php if($item->amount == $item->paidamount): ?>
                                ...
                                <div class="d-flex gap-2">
                                    <div class="edit">
                                        <a href="<?php echo e(route('invoice.details' ,$item->id)); ?>"><button class="btn btn-sm btn-success edit-item-btn">Details</button></a>
                                    </div>
                                    <div class="remove">
                                        <?php if($item->amount == $item->paidamount): ?>
                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>" id="savepayment" data-bs-target="#exampleModalgrid" style="display: none;">
            Payment
       </button> <?php else: ?>
       <button type="button" class="btn btn-sm btn-primary open-modal" data-id="<?php echo e($item->id); ?>" data-customer="<?php echo e($item->customer_id); ?>"data-bs-toggle="modal" data-bs-target="#exampleModalgrid">
        Payment
    </button>
                 <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u411614341/domains/cms.oraclemachinetech.com/public_html/resources/views/apps-invoices-list.blade.php ENDPATH**/ ?>