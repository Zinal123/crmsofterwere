                               ...
                               <div class = "row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary edit"  data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>">
                                                 Edit
                                               </button>  
                                               <button type="button" class="btn btn-danger" id = "delete" data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>">
                                                 Delete
                                               </button> 
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Gear; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item2->id); ?></td>
                                            <td><?php echo e($item2->companyname); ?></td>
                                            <td><?php echo e($item2->image); ?></td>
                                            
                                           
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-id="<?php echo e($item2->id); ?>">
                                                         Edit
                                                       </button>  
                                                       <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-id="<?php echo e($item2->id); ?>">
                                                         Delete
                                                       </button> 
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Rack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item3->id); ?></td>
                                            <td><?php echo e($item3->companyname); ?></td>
                                            <td><?php echo e($item3->image); ?></td>
                                            
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-id="<?php echo e($item3->id); ?>">
                                                    Edit
                                                  </button>  
                                                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-id="<?php echo e($item3->id); ?>">
                                                    Delete
                                                  </button>
                                            </td>
                                        </tr>
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-custom" role="tabpanel" aria-labelledby="custom-v-pills-custom-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Softerwere1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item4->id); ?></td>
                                            <td><?php echo e($item4->companyname); ?></td>
                                            <td><?php echo e($item4->image); ?></td>
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-id="<?php echo e($item4->id); ?>">
                                                    Edit
                                                  </button>  
                                                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-id="<?php echo e($item4->id); ?>">
                                                    Delete
                                                  </button>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('motorstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
...
<div class="modal fade" id="exampleModalgrid1" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('gearstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<div class="modal fade" id="exampleModalgrid2" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('rackstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<div class="modal fade" id="exampleModalgrid3" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('softwarestore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u411614341/domains/cms.oraclemachinetech.com/public_html/resources/views/standerconfiglist.blade.php ENDPATH**/ ?>