...
<?php
$Vender = App\Models\Customer::leftJoin('invoice', 'invoice.customer_id', '=', 'customer.id')
    ->orderBy('customer.id', 'desc')
    ->get(['invoice.*', 'customer.id as customer_id', 'invoice.invoice_id as invoice_id']);
        ...
        <div class="card" id="invoiceList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Vender</h5>
                    ...
                    <div class="table-responsive table-card">
                        ...
                        style="width:100%">
                            ...
                            <tbody class="list form-check-all" id="invoice-list-data">
                                <?php $__currentLoopData = $Vender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u411614341/domains/cms.oraclemachinetech.com/public_html/resources/views/vender.blade.php ENDPATH**/ ?>