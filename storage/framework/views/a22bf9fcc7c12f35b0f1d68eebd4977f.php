        ...
        <div class="card" id="invoiceList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Standerconfig</h5>
                        ...
                        <div class="tab-content text-muted mt-3 mt-lg-0">
                            <div class="tab-pane fade active show" id="custom-v-pills-home" role="tabpanel" aria-labelledby="custom-v-pills-home-tab">
                               ...
                               <div class = "row">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $softwere; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Lasercutting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item1->id); ?></td>
                                            <td><?php echo e($item1->company); ?></td>
                                            <td><?php echo e($item1->product); ?></td>
                                            <td><?php echo e($item1->logo); ?></td>
                                            <td><?php echo e($item1->image); ?></td>
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button"
                                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Focusing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item2->id); ?></td>
                                            <td><?php echo e($item2->company); ?></td>
                                            <td><?php echo e($item2->product); ?></td>
                                            <td><?php echo e($item2->logo); ?></td>
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-custom" role="tabpanel" aria-labelledby="custom-v-pills-custom-tab">
                                <div class = "row">
                                   ...
                                   <div class = "row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $power; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            
                                            <td><?php echo e($item3->id); ?></td>
                                            <td><?php echo e($item3->company); ?></td>
                                            <td><?php echo e($item3->product); ?></td>
                                            <td><?php echo e($item3->logo); ?></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('softerwerestore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
...
<div class="modal fade" id="exampleModalgrid1" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('cuttingstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<div class="modal fade" id="exampleModalgrid2" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('focusingstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<div class="modal fade" id="exampleModalgrid3" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('powerstore')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class ="row">
                        <div class ="col-md-3">
                            <label for="firstName" class="form-label">Company Name</label> 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u411614341/domains/cms.oraclemachinetech.com/public_html/resources/views/standerconfig.blade.php ENDPATH**/ ?>